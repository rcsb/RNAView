    ...
    else if (bseq[i] == 'C' || bseq[i] == 'c')
    {
        ...
        for (k = 1; k <= nh; k++)
        {
            ...
            if (strcmp(hb_atm[k], " O2 ") == 0 ||
                strcmp(hb_atm[k], " N3 ") == 0 ||
                strcmp(hb_atm[k], " N4 ") == 0)
                Watson++;

            if (strcmp(hb_atm[k], " N4 ") == 0 ||
                strcmp(hb_atm[k], " C5 ") == 0 ||
                strcmp(hb_atm[k], " C6 ") == 0)
                Hoogsteen++;
...
/* get the vector of N1(or N9)-->C1' for the given base.*/
{
    ...
    else if (bseq[i] == 'U' || bseq[i] == 'u' || bseq[i] == 'C' || bseq[i] == 'c' || bseq[i] == 'T' || bseq[i] == 't')
    {
        natm = 6;
