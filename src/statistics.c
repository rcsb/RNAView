...
/* get the statistics of all the edge-to-edge interactions */
{
    ...
    for (i = 1; i <= num_pair_tot; i++)
    {
        ...
        if (!strcmp(pair_type[i], "--c") || !strcmp(pair_type[i], "++c"))
            ...
            type_stat[5]++;
        else if (!strcmp(pair_type[i], "SSc") || !strcmp(pair_type[i], "Ssc") || !strcmp(pair_type[i], "sSc"))
            type_stat[6]++;
        else if (!strcmp(pair_type[i], "SSt") || !strcmp(pair_type[i], "Sst") || !strcmp(pair_type[i], "sSt"))
            type_stat[7]++;
